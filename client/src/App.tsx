...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/app/requests"} component={() => <DashboardLayout><Requests /></DashboardLayout>} />
      <Route path={"/app/requests-inbox"} component={() => <DashboardLayout><RequestsInbox /></DashboardLayout>} />
